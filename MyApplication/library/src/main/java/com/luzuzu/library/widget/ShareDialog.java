...
public class ShareDialog extends BaseDialog {
    ...
    //界面显示的数据
    private String[]  mTexts={"微博","微信好友","微信朋友圈"};
    private int[]	  mImgs={R.drawable.icon_wb,R.drawable.icon_wx,
            R.drawable.icon_pyq};//图片数据
    ...
    private View initView() {
        ...
        for(int i=0,j=0;i<num;){
            ...
            for(;i<j*number && i<num;i++){//一行三个
                ...
                params.topMargin=20*mDensity;
                params.bottomMargin=20*mDensity;
                item.setLayoutParams(params);
                item.setBounds(40, 40);//设置图片的宽高
