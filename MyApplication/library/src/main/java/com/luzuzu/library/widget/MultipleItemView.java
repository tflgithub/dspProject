...
import com.luzuzu.library.R;
import com.luzuzu.library.R2;
...
public class MultipleItemView extends LinearLayout {
    ...
    private int leftIconResource = R.drawable.ic_loading;
    private int rightIconResource = R.drawable.ic_loading;
    ...
    public MultipleItemView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        ButterKnife.bind(this, View.inflate(getContext(), R.layout.multiple_item, this));
